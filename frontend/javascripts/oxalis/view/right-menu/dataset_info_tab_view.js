  ...
  render() {
    ...
    return (
      <div className="flex-overflow padded-tab-content">
        <div
          className="ant-notification-notice webknossos-welcome-toast ant-notification-notice-closable"
          style={{ width: "100%", margin: 0, marginBottom: 12 }}
        >
          <div className="ant-notification-notice-content">
            <div className role="alert">
              ...
              <div className="ant-notification-notice-description">
                You are viewing this dataset on webKnossos. webKnossos is an online tool to
                visualise and collaboratively annotate large image datasets. Try out the annotation
                features on the public dataset below. If this is for you, sign up for free, upload
                your data and get started!
              </div>
            </div>
          </div>
