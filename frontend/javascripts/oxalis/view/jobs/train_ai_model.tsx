...
// Therefore, volumeTracings with the matching volumeTracingMags are needed to get more details on each volume annotation layer and its mags.
    ...
    const newAnnotationsWithDatasets = await Promise.all(
      newItems.map(async (item) => {
        ...
        return {
          ...
          dataset,
          volumeTracings,
          volumeTracingMags: volumeServerTracings.map(({ mags: mags }) =>
