...
!!! info  
    The proofreading tool requires a supervoxel-graph-compatible mapping. These mappings are commonly generated by automated segmentation pipelines (for example, [Voxelytics](https://voxelytics.com)). If you need help preparing compatible files, contact [support@webknossos.org](mailto:support@webknossos.org).

## Simultaneous Multi-User Proofreading (Experimental)

The proofreading tool is currently the only tool that supports WEBKNOSSOS's experimental [simultaneous editing / live collaboration mode](../sharing/annotation_sharing.md#simultaneous-editing-experimental), which lets several collaborators proofread the same annotation at the same time.
