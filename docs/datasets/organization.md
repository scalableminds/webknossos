...
New folders can be created by right-clicking a folder in the sidebar and selecting "New Folder" at the root, or "New Subfolder" when right-clicking an existing (non-root) folder.
