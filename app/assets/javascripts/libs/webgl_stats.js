...
export function getWebGLReport() {
  ...
  function getAngle() {
    ...
    if (angle) {
      ...
      if (
        isPowerOfTwo(gl.getParameter(gl.MAX_VERTEX_UNIFORM_VECTORS)) &&
