...
db.users.update({}, {$unset: {dataSetConfigurations: 0, userConfiguration: 0}, $set: {"configuration.settings.brightnessContrastSettings": {default: {brightness: 0, contrast: 1}, "st08x2": {brightness: -90, contrast: 2.4}, "07x2": {brightness: -70, contrast: 2.4}}, "configuration.settings.fourBit": false, "configuration.settings.quality": 0, "configuration.settings.interpolation": false}}, {multi: true})
