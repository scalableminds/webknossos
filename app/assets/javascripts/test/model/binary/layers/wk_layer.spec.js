...
describe("WkLayer", function() {
  ...
  describe("requestFromStore", function() {
    ...
    describe("Token Handling", function() {
      ...
      it("should request a token first", function(done) {

        layer.tokenPromise.then(function(token) {
      ...
      it("should re-request a token when it's invalid", function(done) {
    ...
    describe("Request Handling", function() {
      ...
      it("should pass the correct request parameters", function(done) {
        ...
        layer.requestFromStore(batch).then(function(result) {
  ...
  describe("sendToStore", function() {
    ...
    describe("Request Handling", function() {
      ...
      it("should send the correct request parameters", function(done) {
        ...
        layer.sendToStore(batch, getBucketData).then(function(result) {
