webpackJsonp([12,13],Array(68).concat([
/* 68 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	DatasetModel = (function(superClass) {
	  ...
	  DatasetModel.prototype.createThumbnailURL = function(datasetName, layers) {
	    var colorLayer;
	    if (colorLayer = _.findWhere(layers, {
	      category: "color"
	    })) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	TaskCreateBulkImportView = (function(superClass) {
	  ...
	  TaskCreateBulkImportView.prototype.isValidData = function(bulkText) {
	    return _.every(this.splitToLines(bulkText), this.isValidLine, this);
	  };
	  ...
	  TaskCreateBulkImportView.prototype.isValidLine = function(bulkLine) {
	    ...
	    if (_.any(bulkData, this.isNull, this)) {
	      return false;
	    }
	    if (_.any(bulkData.experienceDomain, isNaN) || _.any(bulkData.editPosition, isNaN) || isNaN(bulkData.boundingBox.width) || isNaN(bulkData.boundingBox.height) || isNaN(bulkData.boundingBox.depth) || _.any(bulkData.boundingBox.topLeft, isNaN)) {
	      return false;
	    }
	    return true;
	  };
	  ...
	  TaskCreateBulkImportView.prototype.parseText = function(bulkText) {
	    return _.map(this.splitToLines(bulkText), this.formatLine, this);
	  };
	
	  TaskCreateBulkImportView.prototype.formatLine = function(bulkLine) {
	    var dataSet, experienceDomain, instances, maxX, maxY, maxZ, minExperience, minX, minY, minZ, projectName, rotX, rotY, rotZ, taskTypeId, team, words, x, y, z;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone, FormatUtils, TaskModel,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	TaskModel = (function(superClass) {
	  ...
	  TaskModel.prototype.destroy = function() {
	    var options;
	    options = {
	      url: "/api/tasks/" + (this.get('id')) + "/delete"
	    };
