webpackJsonp([26],Array(68).concat([
/* 68 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormSyphon, Marionette, Multiselect, SelectionView, TaskTypeCreateView, TeamCollection, Toast, _, app,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	Multiselect = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"bootstrap-multiselect\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	TaskTypeCreateView = (function(superClass) {
	  ...
	  TaskTypeCreateView.prototype.regions = {
	    "team": ".team"
	  };
	
	  TaskTypeCreateView.prototype.events = {
	    "submit form": "submitForm"
	  };
	
	  TaskTypeCreateView.prototype.ui = {
	    "form": "form",
	    "multiselect": "select[multiple='multiple']"
	  };
	
	  TaskTypeCreateView.prototype.initialize = function() {
	  ...
	  TaskTypeCreateView.prototype.submitForm = function(event) {
	    var formValues;
	    ...
	    return this.model.save(formValues).then(function() {
	  ...
	  TaskTypeCreateView.prototype.onRender = function() {
	    ...
	    this.team.show(teamSelectionView);
	    return this.ui.multiselect.multiselect();
	  };
	
	  TaskTypeCreateView.prototype.onDestroy = function() {
