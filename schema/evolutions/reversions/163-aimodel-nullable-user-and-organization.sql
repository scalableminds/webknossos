...
-- Remove pretrained models that have no user/organization (they will be re-inserted by InitialDataController after rollback)
...
ALTER TABLE webknossos.aiModels ALTER COLUMN _organization SET NOT NULL;
