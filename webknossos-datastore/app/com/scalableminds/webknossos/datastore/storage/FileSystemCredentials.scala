...
case class HttpBasicAuthCredential(name: String, username: String, password: String, domain: Option[String])
...
case class S3AccessKeyCredential(name: String, keyId: String, key: String, bucket: Option[String]) extends AnyCredential
