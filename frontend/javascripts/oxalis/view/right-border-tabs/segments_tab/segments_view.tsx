...
import {
  ...
  getMagnificationInfoOfVisibleSegmentationLayer,
...
type StateProps = {
  ...
  resolutionInfoOfVisibleSegmentationLayer: MagnificationInfo;
};
...
const mapStateToProps = (state: OxalisState): StateProps => {
  ...
  return {
    ...
    resolutionInfoOfVisibleSegmentationLayer: getMagnificationInfoOfVisibleSegmentationLayer(state),
  };
};
