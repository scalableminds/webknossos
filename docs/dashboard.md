...
You can also add custom tags to annotations in order to organize them. Click one or several of your tags if you want to be shown a particular group of annotations. 
