webpackJsonp([24,25],Array(68).concat([
/* 68 */
	...
	SelectionItemView = (function(superClass) {
	  ...
	  SelectionItemView.prototype.attributes = function() {
	    ...
	    if (this.options.defaultItem) {
	      ref = _.toPairs(this.options.defaultItem)[0], key = ref[0], value = ref[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SortedCollection, TeamCollection, TeamModel, _,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
...
/***/ function(module, exports, __webpack_require__) {
	...
	TaskTypeModel = (function(superClass) {
	  ...
	  TaskTypeModel.prototype.urlRoot = "/api/taskTypes";
	
	  TaskTypeModel.prototype.defaults = {
	    summary: "",
	    description: "",
	    settings: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone, ProjectCollection, ProjectModel, _,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
...
/***/ function(module, exports, __webpack_require__) {
	...
	Utils = {
	  ...
	  compareBy: function(key, isSortedAscending) {
	  ...
	  getUrlParams: function(paramName) {
	    var params;
	    params = window.location.search.substring(1).split("&").reduce(function(result, value) {
	      var key, parts;
	      parts = value.split('=');
	      if (parts[0]) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AbstractTabView, TaskCreateBulkImportView, TaskCreateFromView, TaskCreateView,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	
	TaskCreateFromView = __webpack_require__(331);
	
	TaskCreateBulkImportView = __webpack_require__(337);
	
	AbstractTabView = __webpack_require__(195);
	
	TaskCreateView = (function(superClass) {
	  extend(TaskCreateView, superClass);
	
	  function TaskCreateView() {
	    return TaskCreateView.__super__.constructor.apply(this, arguments);
	  }
	
	  TaskCreateView.prototype.id = "task-create";
	
	  TaskCreateView.prototype.getTabs = function() {
	    return [
	      {
	        active: true,
	  ...
	  TaskCreateView.prototype.onRender = function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormSyphon, Marionette, ProjectCollection, SelectionView, TaskCreateFromFormView, TaskCreateFromNMLView, TaskCreateFromView, TaskTypeCollection, TeamCollection, Toast, Utils, _, routes,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	routes = __webpack_require__(183);
	...
	TaskCreateFromView = (function(superClass) {
	  ...
	  TaskCreateFromView.prototype.templateHelpers = function() {
	    return {
	      ...
	      getActionName: (function(_this) {
	        return function() {
	          return _this.getActionName();
	        };
	      })(this)
	    };
	  };
	
	  TaskCreateFromView.prototype.regions = {
	    "taskType": ".taskType",
	    "team": ".team",
	    "project": ".project",
	    "subview": ".subview"
	  ...
	  TaskCreateFromView.prototype.events = {
	    "submit": "submit"
	  };
	
	  TaskCreateFromView.prototype.ui = {
	    form: "#createForm",
	  ...
	  TaskCreateFromView.prototype.initialize = function(options) {
	  ...
	  TaskCreateFromView.prototype.getActionName = function() {
	    if (this.isEditingMode) {
	      return "Update";
	    } else {
	      return "Create";
	  ...
	  TaskCreateFromView.prototype.submit = function() {
	    this.toggleSubmitButton(true);
	    return this.createSubview.submit();
	  };
	
	  TaskCreateFromView.prototype.toggleSubmitButton = function(state) {
	    this.ui.submitButton.prop("disabled", state);
	    return this.ui.submitButton.toggleClass("disabled", state);
	  };
	
	  TaskCreateFromView.prototype.serializeForm = function() {
	    var formValues;
	  ...
	  TaskCreateFromView.prototype.parseBoundingBox = function(string) {
	    var intArray;
	    if (_.isEmpty(string)) {
	      return;
	    }
	  ...
	  TaskCreateFromView.prototype.onRender = function() {
	    this.taskTypeSelectionView = new SelectionView({
	      ...
	      childViewOptions: {
	        ...
	        defaultItem: {
	          id: this.model.get("type.id") || Utils.getUrlParams("taskType")
	        }
	      },
	    ...
	    this.projectSelectionView = new SelectionView({
	      ...
	      childViewOptions: {
	        ...
	        defaultItem: {
	          name: this.model.get("projectName") || Utils.getUrlParams("projectName")
	        }
	      },
	      data: "amIAnAdmin=true",
	      name: "projectName",
	    ...
	    this.taskType.show(this.taskTypeSelectionView);
	    this.team.show(this.teamSelectionView);
	    this.project.show(this.projectSelectionView);
	    if (this.type === "from_form") {
	      this.createSubview = new TaskCreateFromFormView({
	        model: this.model,
	        parent: this
	      });
	    } else if (this.type === "from_nml") {
	      this.createSubview = new TaskCreateFromNMLView({
	        model: this.model,
	        parent: this
	      });
	    } else {
	    ...
	    return this.subview.show(this.createSubview);
	  };
	
	  return TaskCreateFromView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatasetCollection, Marionette, SelectionView, TaskCreateFromFormView, Utils, _, routes,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	DatasetCollection = __webpack_require__(334);
	
	SelectionView = __webpack_require__(68);
	
	Utils = __webpack_require__(188);
	
	TaskCreateFromFormView = (function(superClass) {
	  extend(TaskCreateFromFormView, superClass);
	
	  function TaskCreateFromFormView() {
	    return TaskCreateFromFormView.__super__.constructor.apply(this, arguments);
	  }
	
	  TaskCreateFromFormView.prototype.id = "create-from-form";
	
	  TaskCreateFromFormView.prototype.CLEAR_ON_SUCCESS = true;
	
	  TaskCreateFromFormView.prototype.template = _.template("<div class=\" form-group\">\n  <label class=\"col-sm-2 control-label\" for=\"dataSet\">Dataset</label>\n  <div class=\"col-sm-9 dataSet\">\n  </div>\n</div>\n\n<div class=\" form-group\">\n  <label class=\"col-sm-2 control-label\" for=\"editPosition\">Start</label>\n  <div class=\"col-sm-9\">\n    <input\n      type=\"text\"\n      id=\"editPosition\"\n      name=\"editPosition\"\n      placeholder=\"x, y, z\"\n      title=\"x, y, z\"\n      pattern=\"(\\s*\\d+\\s*,){2}(\\s*\\d+\\s*)\"\n      value=\"<%- editPosition %>\"\n      required\n      class=\"form-control\">\n  </div>\n</div>\n\n<div class=\" form-group\">\n  <label class=\"col-sm-2 control-label\" for=\"editRotation\">Start Rotation</label>\n  <div class=\"col-sm-9\">\n    <input\n      type=\"text\"\n      id=\"editRotation\"\n      name=\"editRotation\"\n      placeholder=\"Rotation x, Rotation y, Rotation z\"\n      title=\"Rotation x, Rotation y, Rotation z\"\n      pattern=\"(\\s*\\d+\\s*,){2}(\\s*\\d+\\s*)\"\n      value=\"<%- editRotation %>\"\n      required\n      class=\"form-control\">\n  </div>\n</div>");
	
	  TaskCreateFromFormView.prototype.regions = {
	    "dataSet": ".dataSet"
	  };
	
	  TaskCreateFromFormView.prototype.ui = {
	    "editPosition": "#editPosition",
	    "editRotation": "#editRotation"
	  };
	
	  TaskCreateFromFormView.prototype.initialize = function(options) {
	    return this.parent = options.parent;
	  };
	
	  TaskCreateFromFormView.prototype.serializeForm = function() {
	    var formValues;
	    formValues = this.parent.serializeForm();
	  ...
	  TaskCreateFromFormView.prototype.submit = function() {
	    var serializedForm;
	    serializedForm = this.serializeForm();
	    this.model.save(serializedForm, {
	      ...
	      error: (function(_this) {
	        return function() {
	          return _this.parent.showSaveError();
	        };
	      })(this),
	      success: (function(_this) {
	        return function(task) {
	          return _this.parent.showSaveSuccess(task);
	        };
	      })(this)
	    });
	    return false;
	  ...
	  * Render a dataset SelectionView.
	  ...
	  TaskCreateFromFormView.prototype.onRender = function() {
	    ...
	    return this.dataSet.show(this.dataSetSelectionView);
	  };
	
	  return TaskCreateFromFormView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatasetCollection, DatasetModel, SortedCollection,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	
	SortedCollection = __webpack_require__(74);
	
	DatasetModel = __webpack_require__(335);
	...
	DatasetCollection = (function(superClass) {
	  ...
	  DatasetCollection.prototype.url = "/api/datasets";
	
	  DatasetCollection.prototype.model = DatasetModel;
	
	  DatasetCollection.prototype.sortAttribute = "name";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatasetModel, NestedObjModel, _, backbone, moment,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	DatasetModel = (function(superClass) {
	  ...
	  DatasetModel.prototype.urlRoot = "/api/datasets";
	
	  DatasetModel.prototype.idAttribute = "name";
	
	  DatasetModel.prototype.parse = function(response) {
	    ...
	    response.hasSegmentation = _.some(response.dataSource.dataLayers, function(layer) {
	      return layer.category === "segmentation";
	    });
	  ...
	  DatasetModel.prototype.createThumbnailURL = function(datasetName, layers) {
	    var colorLayer;
	    if (colorLayer = _.find(layers, {
	      category: "color"
	    })) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, Request, TaskCreateFromNMLView, Toast, _, routes,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	TaskCreateFromNMLView = (function(superClass) {
	  extend(TaskCreateFromNMLView, superClass);
	
	  function TaskCreateFromNMLView() {
	    return TaskCreateFromNMLView.__super__.constructor.apply(this, arguments);
	  }
	
	  TaskCreateFromNMLView.prototype.id = "create-from-nml";
	
	  TaskCreateFromNMLView.prototype.template = _.template("<div class=\"form-group\">\n  <label class=\"col-sm-2 control-label\" for=\"nmlFile\">Reference NML File</label>\n  <div class=\"col-sm-9\">\n    <div class=\"fileinput fileinput-new input-group\" data-provides=\"fileinput\">\n      <div class=\"form-control\" data-trigger=\"fileinput\">\n        <i class=\"fa fa-file fileinput-exists\"></i>\n        <span class=\"fileinput-filename\"></span>\n      </div>\n      <span class=\"input-group-addon btn btn-default btn-file\">\n        <span class=\"fileinput-new\">Browse...</span>\n        <span class=\"fileinput-exists\">Change</span>\n        <input type=\"file\" accept=\".nml\" name=\"nmlFile\" title=\"Please select at least one .nml file\" required>\n      </span>\n      <a href=\"#\" class=\"input-group-addon btn btn-default fileinput-exists\" data-dismiss=\"fileinput\">Remove</a>\n    </div>\n  </div>\n</div>");
	
	  TaskCreateFromNMLView.prototype.ui = {
	    "fileUpload": "[type=file]"
	  };
	
	  TaskCreateFromNMLView.prototype.initialize = function(options) {
	    return this.parent = options.parent;
	  };
	  ...
	  TaskCreateFromNMLView.prototype.submit = function() {
	    var form, payload, serializedForm;
	    serializedForm = this.parent.serializeForm();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, Request, TaskCreateBulkImportView, Toast, _, routes,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	TaskCreateBulkImportView = (function(superClass) {
	  extend(TaskCreateBulkImportView, superClass);
	
	  function TaskCreateBulkImportView() {
	    this.showSaveSuccess = bind(this.showSaveSuccess, this);
	    return TaskCreateBulkImportView.__super__.constructor.apply(this, arguments);
	  }
	
	  TaskCreateBulkImportView.prototype.id = "create-bulk-import";
	
	  TaskCreateBulkImportView.prototype.template = _.template("<div class=\"row\">\n  <div class=\"col-sm-12\">\n    <div class=\"well\">\n      One line for each task. The values are seperated by ','. Format: <br>\n      dataSet, <a href=\"/taskTypes\">taskTypeId</a>, experienceDomain, minExperience, x, y, z, rotX, rotY, rotZ, instances, team, minX, minY, minZ, width, height, depth, project<br><br>\n      <form action=\"\" method=\"POST\" class=\"form-horizontal\" onSubmit=\"return false;\">\n        <div class=\"form-group\">\n          <div class=\"col-sm-12\">\n            <textarea class=\"form-control input-monospace\" rows=\"20\" name=\"data\"></textarea>\n          </div>\n        </div>\n        <div class=\"form-group\">\n          <div class=\"col-sm-offset-10 col-sm-2\">\n            <button type=\"submit\" class=\"form-control btn btn-primary\">Import</button>\n          </div>\n        </div>\n      </form>\n    </div>\n  </div>\n</div>");
	
	  TaskCreateBulkImportView.prototype.events = {
	    "submit": "submit"
	  };
	
	  TaskCreateBulkImportView.prototype.ui = {
	  ...
	  TaskCreateBulkImportView.prototype.submit = function() {
	    var bulkText, tasks;
	    bulkText = this.ui.bulkText.val();
	    if (!this.isValidData(bulkText)) {
	      this.showInvalidData();
	      return;
	    }
	    tasks = this.parseText(bulkText);
	  ...
	  TaskCreateBulkImportView.prototype.showSaveSuccess = function(response) {
	    if (response.errors) {
	      return this.handleSuccessfulRequest(response.items);
	    } else {
	      this.ui.bulkText.val("");
	      return Toast.success("All tasks were successfully created");
	    }
	  };
	
	  TaskCreateBulkImportView.prototype.showSaveError = function() {
	    return Toast.error("The tasks could not be created due to server errors.");
	  };
	
	  TaskCreateBulkImportView.prototype.showInvalidData = function() {
	    return Toast.error("The form data is not correct.");
	  };
	
	  TaskCreateBulkImportView.prototype.handleSuccessfulRequest = function(items) {
	    var bulkText, errorMessages, failedTasks, i, item, j, len, tasks;
	    bulkText = this.ui.bulkText.val();
	    tasks = this.splitToLines(bulkText);
	    failedTasks = [];
	    errorMessages = [];
	    ...
	    errorMessages = errorMessages.map(function(text, i) {
	      return "Line " + i + " : " + text;
	    });
	  ...
	  TaskCreateBulkImportView.prototype.splitToLines = function(string) {
	    return string.trim().split("\n");
	  };
	
	  TaskCreateBulkImportView.prototype.splitToWords = function(string) {
	    return string.split(",").map(_.trim);
	  };
	
	  TaskCreateBulkImportView.prototype.isValidData = function(bulkText) {
	    return _.every(this.splitToLines(bulkText), this.isValidLine.bind(this));
	  };
	
	  TaskCreateBulkImportView.prototype.isNull = function(value) {
	    return value === null;
	  };
	
	  TaskCreateBulkImportView.prototype.isValidLine = function(bulkLine) {
	    var bulkData;
	    bulkData = this.formatLine(bulkLine);
	    if (bulkData === null) {
	      return false;
	    }
	    ...
	    if (_.some(bulkData.experienceDomain, isNaN) || _.some(bulkData.editPosition, isNaN) || isNaN(bulkData.boundingBox.width) || isNaN(bulkData.boundingBox.height) || isNaN(bulkData.boundingBox.depth) || _.some(bulkData.boundingBox.topLeft, isNaN)) {
	      return false;
	    }
	    return true;
	  };
	
	  TaskCreateBulkImportView.prototype.parseText = function(bulkText) {
	    return _.map(this.splitToLines(bulkText), this.formatLine.bind(this));
	  };
	
	  TaskCreateBulkImportView.prototype.formatLine = function(bulkLine) {
	    var dataSet, depth, experienceDomain, height, instances, minExperience, minX, minY, minZ, projectName, rotX, rotY, rotZ, taskTypeId, team, width, words, x, y, z;
	    words = this.splitToWords(bulkLine);
	    if (words.length < 19) {
	      return null;
	    }
	    dataSet = words[0];
	  ...
	  return TaskCreateBulkImportView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Backbone, FormatUtils, NestedObjModel, TaskModel,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	TaskModel = (function(superClass) {
	  ...
	  TaskModel.prototype.url = function() {
	    var id;
	    id = '';
	    if (this.get('id') != null) {
	      id = '/' + this.get('id');
	  ...
	  TaskModel.prototype.destroy = function() {
	    var options;
	    options = {
	      url: "/api/tasks/" + (this.get('id'))
	    };
	    return TaskModel.__super__.destroy.call(this, options);
	  };
