...
test("Flycam Accessors should calculate the offsets", (t) => {
  t.deepEqual(
    accessors.getOffsets(initialState, OrthoViews.PLANE_XY),
    [134.7, 140.2],
  );
  t.deepEqual(
    accessors.getOffsets(initialState, OrthoViews.PLANE_XZ),
    [134.7, 196.6],
  );
  t.deepEqual(
    accessors.getOffsets(initialState, OrthoViews.PLANE_YZ),
    [196.6, 140.2],
  );
});
...
test("Flycam Accessors should calculate the area", (t) => {
  t.deepEqual(
    accessors.getArea(initialState, OrthoViews.PLANE_XY),
    [134.7, 140.2, 384.3, 389.8],
  );
  t.deepEqual(
    accessors.getArea(initialState, OrthoViews.PLANE_XZ),
    [134.7, 196.6, 384.3, 321.4],
  );
  t.deepEqual(
    accessors.getArea(initialState, OrthoViews.PLANE_YZ),
    [196.6, 140.2, 321.4, 389.8],
  );
});
