...
import com.scalableminds.webknossos.datastore.datastore.VolumeTracing.VolumeTracing.{ElementClass => ProtoElementClass}
import com.scalableminds.webknossos.datastore.datastore.geometry.{BoundingBox => ProtoBoundingBox, Point3D => ProtoPoint3D, Vector3D => ProtoVector3D}
