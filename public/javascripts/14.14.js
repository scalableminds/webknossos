webpackJsonp([14,15],Array(68).concat([
/* 68 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, TaskTypeFormView, TaskTypeListView, TaskTypeView, _, app,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	TaskTypeListView = __webpack_require__(340);
	
	TaskTypeFormView = __webpack_require__(342);
	
	TaskTypeView = (function(superClass) {
	  extend(TaskTypeView, superClass);
	
	  function TaskTypeView() {
	    return TaskTypeView.__super__.constructor.apply(this, arguments);
	  }
	
	  TaskTypeView.prototype.className = "container task-types-administration";
	
	  TaskTypeView.prototype.template = _.template("<div class=\"form\"></div>\n<div class=\"list\"></div>");
	
	  TaskTypeView.prototype.regions = {
	    "form": ".form",
	    "list": ".list"
	  };
	
	  TaskTypeView.prototype.initialize = function() {
	    this.listView = new TaskTypeListView({
	      collection: this.collection
	    });
	    return this.formView = new TaskTypeFormView({
	      collection: this.collection
	    });
	  };
	
	  TaskTypeView.prototype.onRender = function() {
	    this.form.show(this.formView);
	    return this.list.show(this.listView);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, TaskTypeItemView, TaskTypeListView, _, app,
	...
	TaskTypeItemView = __webpack_require__(341);
	
	TaskTypeListView = (function(superClass) {
	  extend(TaskTypeListView, superClass);
	
	  function TaskTypeListView() {
	    this.template = bind(this.template, this);
	    return TaskTypeListView.__super__.constructor.apply(this, arguments);
	  }
	
	  TaskTypeListView.prototype.template = function() {
	    return _.template("<table class=\"table table-striped table-details\" id=\"tasktype-table\">\n  <thead>\n    <tr>\n      <th> # </th>\n      <th> Team </th>\n      <th> Summary </th>\n      <th> Description </th>\n      <th> Add-On Modes </th>\n      <th> Settings </th>\n      <th> Expected Time </th>\n      <th> Attached File </th>\n      <th></th>\n    </tr>\n  </thead>\n  <tbody></tbody>\n</table>");
	  };
	
	  TaskTypeListView.prototype.childView = TaskTypeItemView;
	
	  TaskTypeListView.prototype.childViewContainer = "tbody";
	
	  TaskTypeListView.prototype.initialize = function() {
	    return this.collection.fetch();
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, TaskTypeItemView, Toast, _,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Marionette, Request, SelectionView, TaskTypeFormView, TeamCollection, Toast, _, app,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty,
	...
	TaskTypeFormView = (function(superClass) {
	  ...
	  TaskTypeFormView.prototype.regions = {
	    "team": ".team"
	  };
	
	  TaskTypeFormView.prototype.events = {
	    "submit form": "submitForm"
	  };
	
	  TaskTypeFormView.prototype.ui = {
	    "form": "form",
	  ...
	  TaskTypeFormView.prototype.initialize = function() {
	    this.isEditMode = this.options.isEditMode;
	    if (this.isEditMode) {
	      return this.model.fetch().then((function(_this) {
	        return function() {
	          return _this.prefillForm();
	        };
	      })(this));
	    }
	  };
	
	  TaskTypeFormView.prototype.prefillForm = function() {
	    var inputStrings, numValues, settings;
	    this.ui.summary.val(this.model.get("summary"));
	    this.ui.description.val(this.model.get("description"));
	    settings = this.model.get("settings");
	    this.ui.orthogonalAllowed.attr("checked", indexOf.call(settings.allowedModes, "orthogonal") >= 0);
	    this.ui.obliqueAllowed.attr("checked", indexOf.call(settings.allowedModes, "oblique") >= 0);
	    this.ui.flightAllowed.attr("checked", indexOf.call(settings.allowedModes, "flight") >= 0);
	    this.ui.branchPointsAllowed.attr("checked", settings["branchPointsAllowed"]);
	    this.ui.advancedOptionsAllowed.attr("checked", settings["advancedOptionsAllowed"]);
	    this.ui.somaClickingAllowed.attr("checked", settings["somaClickingAllowed"]);
	    if (settings.preferredMode) {
	      this.ui.preferredMode.val(settings.preferredMode);
	    }
	    inputStrings = ["expectedTime_minTime", "expectedTime_maxTime", "expectedTime_maxHard"];
	    numValues = this.model.get("expectedTime").match(/([0-9]+) - ([0-9]+), Limit: ([0-9]+)/).slice(1).map(parseFloat);
	    return _.each(_.zip(inputStrings, numValues), (function(_this) {
	      return function(inputAndNum) {
	        var input, num;
	        input = inputAndNum[0], num = inputAndNum[1];
	        return _this.$("#" + input).val(num);
	      };
	    })(this));
	  };
	
	  TaskTypeFormView.prototype.submitForm = function(event) {
	    var target, url;
	    ...
	    url = this.isEditMode ? "/api/taskTypes/" + (this.model.get("id")) : "/api/taskTypes";
	    return Request.sendUrlEncodedFormReceiveJSON(url, {
	      data: target
	    }).then((function(_this) {
	      return function(response) {
	        Toast.message(response.messages);
	        if (_this.isEditMode) {
	          return app.router.navigate("/taskTypes", {
	            trigger: true
	          });
	        } else {
	          _this.collection.addJSON(response.newTaskType);
	          return _this.render();
	        }
	      };
	    })(this));
	  ...
	  TaskTypeFormView.prototype.onRender = function() {
	    var teamSelectionView;
	    ...
	    return this.team.show(teamSelectionView);
	  };
	
	  return TaskTypeFormView;
