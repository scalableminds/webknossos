...
import { getMappingInfo, getMagnificationInfo } from "oxalis/model/accessors/dataset_accessor";
...
export function SegmentStatisticsModal({
  ...
  const magInfo = getMagnificationInfo(visibleSegmentationLayer.resolutions);
