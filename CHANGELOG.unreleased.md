...
- Measurement tools are now accessible when viewing datasets outside an annotation. [#8334](https://github.com/scalableminds/webknossos/pull/8334)
- Failed jobs may be resumed by super-users. [#8377](https://github.com/scalableminds/webknossos/pull/8377)
