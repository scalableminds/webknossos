...
class WebknossosEnvironment @Inject()(configuration: Configuration, userService: UserService)(implicit val executionContext: ExecutionContext) extends Environment[User, CombinedAuthenticator] {
