...
test("Data Api: downloadRawVolumeTracingCuboid should open a popup with the correct URL", async t => {
  ...
  t.true(
    window.open.calledWith(
      "http://localhost:9000/data/datasets/2012-09-28_ex145_07x2/layers/64007765-cef9-4e31-b206-dba795b5be17/data?resolution=0&token=undefined&x=1&y=2&z=3&width=8&height=6&depth=4",
    ),
  );
});
