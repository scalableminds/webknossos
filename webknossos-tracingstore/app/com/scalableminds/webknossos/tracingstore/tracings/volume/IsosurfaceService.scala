...
import com.scalableminds.webknossos.datastore.services.{BinaryDataService, IsosurfaceRequest}
...
class IsosurfaceService @Inject()(
  ...
  private def generateIsosurfaceImpl[T: ClassTag, B <: Buffer](
    ...
    val dataRequest = DataServiceDataRequest(null,
                                             request.dataLayer.asInstanceOf[VolumeTracingLayer],
                                             None,
                                             cuboid,
