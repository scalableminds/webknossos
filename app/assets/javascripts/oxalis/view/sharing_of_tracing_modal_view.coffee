    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3>Sharing of tracing</h3>
        </div>
        <div class="modal-body container-fluid">
          <div class="form-group">
            <label for="task">Link to share</label>
            <div class="row">
              <div class="col-md-8 link">
                <span class="input-xlarge uneditable-input">
                  http://localhost:9000/annotations/Explorational/541439fcdd22fb8e00b98b27#64,64,64,0,0.00
                </span>
              </div>
              <div class="col-md-2">
                <button class="btn btn-primary" id="task-merge">Copy</button>
              </div>
              <div class="col-md-2">
                <button class="btn btn-primary" id="task-merge">Mail</button>
              </div>
            </div>
          </div>
          <div class="form-group">
            <label for="task-type">Privileges</label>
            <div class="row">
              <div class="checkbox">
              <label>
