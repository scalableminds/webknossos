...
class SkeletonTracingService @Inject()(
    ...
    val temporaryTracingStore: TemporaryTracingStore[SkeletonTracing])(implicit ec: ExecutionContext)
  ...
  def handleUpdateGroup(tracingId: String,
    ...
    tracingDataStore.skeletonUpdates.put(tracingId,
                                         updateActionGroup.version,
                                         updateActionGroup.actions.map(_.addTimestamp(updateActionGroup.timestamp)))
