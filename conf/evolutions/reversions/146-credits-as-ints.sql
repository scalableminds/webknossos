...
DROP FUNCTION webknossos.hand_out_monthly_free_credits(INT); -- old signature

-- 2. migrate table
DROP VIEW webknossos.credit_transactions_;
ALTER TABLE webknossos.credit_transactions ADD COLUMN credit_delta DECIMAL(14, 3);
UPDATE webknossos.credit_transactions SET credit_delta = (milli_credit_delta / 1000.0);
ALTER TABLE webknossos.credit_transactions ALTER COLUMN credit_delta SET NOT NULL;
ALTER TABLE webknossos.credit_transactions DROP COLUMN milli_credit_delta;
