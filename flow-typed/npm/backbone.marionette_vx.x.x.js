...
declare module 'backbone.marionette' {
  ...
  */
  ...
  declare interface RegionEmptyOptions {
  ...
  */
  declare class Region mixins Object {
  ...
  */
  declare class RegionManager mixins Controller {
    ...
    */
     ...
     */
    all(
      iterator: (element: Region, index: number) => boolean,
      context?: any): boolean;
    ...
    */
    each(
      iterator: (element: Region, index: number, list?: any) => void,
      context?: any): void;
    ...
    */
     ...
     */
    map(
      iterator: (element: Region, index: number, context?: any) => any[],
      context?: any): any[];
  ...
  */
  ...
  declare type CollectionViewOptions<TModel>= {
  ...
  */
  declare class CollectionView<TModel, TView> extends View<TModel>{
    ...
    */
    attachHtml(
      collectionView: CollectionView<TModel, TView>,
      childView: TView,
      index: number): void;
  ...
  */
  ...
  declare type LayoutViewOptions<TModel>= {
  ...
  */
  declare class Behavior mixins Object {
