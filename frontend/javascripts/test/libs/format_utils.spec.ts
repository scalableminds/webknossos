...
test("Format conversion in 1D", (t) => {
...
test("Format number to volume", (t) => {
  t.is(`0.1${ThinSpace}nm³`, formatNumberToVolume(1e-1, LengthUnit.nm));
...
test("Test uncommon number formats", (t) => {
  ...
  t.is(`0.55${ThinSpace}m`, formatNumberToLength(5.5, LengthUnit.dm, 2));
  t.is(`1.0${ThinSpace}km`, formatNumberToLength(10, LengthUnit.hm, 2));
  t.is(`0.55${ThinSpace}km`, formatNumberToLength(5.5, LengthUnit.hm, 2));
  t.is(`1.0${ThinSpace}nm`, formatNumberToLength(10, LengthUnit.Å, 2));
  t.is(`0.55${ThinSpace}nm`, formatNumberToLength(5.5, LengthUnit.Å, 2));
  t.is(`0.25${ThinSpace}m`, formatNumberToLength(10, LengthUnit.in, 2));
  t.is(`0.13${ThinSpace}m`, formatNumberToLength(5.5, LengthUnit.in, 2));
  ...
  t.is(`16.09${ThinSpace}m`, formatNumberToLength(10, LengthUnit.mi, 2));
  t.is(`8.85139${ThinSpace}km`, formatNumberToLength(5.5, LengthUnit.mi, 2));
  t.is(`308.57${ThinSpace}Pm`, formatNumberToLength(10, LengthUnit.pc, 2));
  t.is(`169.72${ThinSpace}Pm`, formatNumberToLength(5.5, LengthUnit.pc, 2));
});
