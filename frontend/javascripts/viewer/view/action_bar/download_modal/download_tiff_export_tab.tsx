...
import { doWithToken, downloadWithFilename } from "admin/rest_api";
import { Alert, Checkbox, Col, Divider, Radio, Row, Typography } from "antd";
...
import { computeBoundingBoxFromBoundingBoxObject, computeShapeFromBoundingBox } from "libs/utils";
...
import { MoreInfoHint } from "./download_info_shared";
...
export function TiffExportTab({
  ...
  const isOkButtonDisabled = !isExportable || isCurrentlyRunningExportJob || isMergerModeEnabled;
  ...
  return (
    <>
      ...
      <div>
        ...
        {(selectedLayerInfos.additionalAxes?.length || 0) > 0 && (
          <Row>
            ...
            >
              Your dataset has more than three dimensions. The export will only include the selected
              bounding box at the current additional dimensions:{" "}
      ...
      />
      <MoreInfoHint typeDependentFileName="datasets" />
      <Checkbox
