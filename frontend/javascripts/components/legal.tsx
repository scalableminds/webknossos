      ...
      <Row>
        <Col offset={6} span={12}>
          ...
          <p>
            ...
            application and to provide online reports, which show the activities on our websites,
          ...
          <p>
            ...
            thus permanently deny the setting of cookies. Such an adjustment to the Internet browser
            used would also prevent Google Analytics from setting a cookie on the information
