webpackJsonp([17],Array(71).concat([
/* 71 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	TemplateHelpers = {
	  ...
	  formatScale: function(scaleArr) {
	    var scaleArrRounded;
	    if ((scaleArr != null ? scaleArr.length : void 0) > 0) {
	      scaleArrRounded = scaleArr.map(function(value) {
	        return utils.roundTo(value, 2);
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatasetModel, PaginatedDatasetCollection, PaginationCollection,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	PaginatedDatasetCollection = (function(superClass) {
	  extend(PaginatedDatasetCollection, superClass);
	
	  function PaginatedDatasetCollection() {
	    return PaginatedDatasetCollection.__super__.constructor.apply(this, arguments);
	  }
	
	  PaginatedDatasetCollection.prototype.url = "/api/datasets";
	
	  PaginatedDatasetCollection.prototype.model = DatasetModel;
	
	  PaginatedDatasetCollection.prototype.state = {
	    pageSize: 10
	  };
	
	  return PaginatedDatasetCollection;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, SpotlightDatasetListView, SpotlightDatasetView, _,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	SpotlightDatasetView = __webpack_require__(369);
	
	SpotlightDatasetListView = (function(superClass) {
	  extend(SpotlightDatasetListView, superClass);
	
	  function SpotlightDatasetListView() {
	    return SpotlightDatasetListView.__super__.constructor.apply(this, arguments);
	  }
	
	  SpotlightDatasetListView.prototype.childView = SpotlightDatasetView;
	
	  SpotlightDatasetListView.prototype.initialize = function(options) {
	    this.listenTo(app.vent, "paginationView:filter", this.filterBySearch);
	    this.collection.setSorting("created", "desc");
	    return this.collection.setCollectionFilter(function(child) {
	      return child.get("isActive");
	    });
	  };
	
	  SpotlightDatasetListView.prototype.filterBySearch = function(searchQuery) {
	    return this.collection.setFilter(["name", "owningTeam", "description"], searchQuery);
	  };
	
	  return SpotlightDatasetListView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Marionette, SpotlightDatasetView, TemplateHelpers, _,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	SpotlightDatasetView = (function(superClass) {
	  ...
	  SpotlightDatasetView.prototype.onShow = function() {
	    this.$(".link-row > a").tooltip({
	      placement: "bottom"
	    });
	  ...
	  SpotlightDatasetView.prototype.submitForm = function(type, event) {
	    event.preventDefault();
	    this.ui.contentTypeInput.val(type);
	    return this.ui.form.submit();
	  };
	
	  return SpotlightDatasetView;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Marionette, PaginationView, _, app,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	PaginationView = (function(superClass) {
	  ...
	  PaginationView.prototype.goFirst = function(evt) {
	    if (evt != null) {
	      evt.preventDefault();
	    }
	  ...
	  PaginationView.prototype.goLast = function(evt) {
	    if (evt != null) {
	      evt.preventDefault();
	    }
	  ...
	  PaginationView.prototype.goBack = function(evt) {
	    if (evt != null) {
	      evt.preventDefault();
	    }
	  ...
	  PaginationView.prototype.goNext = function(evt) {
	    if (evt != null) {
	      evt.preventDefault();
	    }
	  ...
	  PaginationView.prototype.handleClickPage = function(evt) {
	    var page;
	    if (evt != null) {
	      evt.preventDefault();
	    }
	  ...
	  PaginationView.prototype.goToPage = function(page) {
	    return this.collection.getPage(page);
	  };
	
	  PaginationView.prototype.addElement = function() {
	    return app.vent.trigger("paginationView:addElement");
	  };
	
	  PaginationView.prototype.filterBySearch = function() {
	    var filterQuery;
	    filterQuery = this.ui.inputSearch.val();
	  ...
	  PaginationView.prototype.render = function() {
	    ...
	    obj = this.templateHelpers();
	    if (!this.isRendered) {
	      this.$el.html(this.template(obj));
	      this.isRendered = true;
	    }
	    this.$el.find("ul.pagination").html(this.pagingatorTemplate(obj));
	    this.bindUIElements();
	    this.triggerMethod('render', this);
	    return this;
	  };
	
	  PaginationView.prototype.searchByHash = function() {
	    var hash;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreditsView, Marionette, PaginationView, SpotlightDatasetListView, SpotlightView, _,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	CreditsView = __webpack_require__(373);
	
	SpotlightDatasetListView = __webpack_require__(368);
	
	PaginationView = __webpack_require__(370);
	
	SpotlightView = (function(superClass) {
	  extend(SpotlightView, superClass);
	
	  function SpotlightView() {
	    return SpotlightView.__super__.constructor.apply(this, arguments);
	  }
	
	  SpotlightView.prototype.className = "spotlight-view";
	
	  SpotlightView.prototype.template = _.template("<div class=\"container\">\n  <div id=\"oxalis-header\">\n    <img src=\"/assets/images/oxalis.svg\">\n    <div><p>webKnossos</p></div>\n  </div>\n  <div id=\"pagination\"></div>\n  <div id=\"datasets\" class=\"container wide\"></div>\n</div>\n<div id=\"credits\"></div>");
	
	  SpotlightView.prototype.regions = {
	    pagination: "#pagination",
	    credits: "#credits",
	    datasets: "#datasets"
	  };
	
	  SpotlightView.prototype.initialize = function() {
	    this.paginationView = new PaginationView({
	      collection: this.collection
	    });
	    this.spotlightDatasetListView = new SpotlightDatasetListView({
	      collection: this.collection
	    });
	    ...
	    return this.listenTo(this, "render", this.show);
	  };
	
	  SpotlightView.prototype.show = function() {
	    this.pagination.show(this.paginationView);
	    this.datasets.show(this.spotlightDatasetListView);
	    return this.credits.show(this.creditsView);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreditsView, Marionette, _, routes,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
