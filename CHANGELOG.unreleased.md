...
- Add new backend API routes for using private zarr links to annotations as well as creating them. [#6367](https://github.com/scalableminds/webknossos/pull/6367)
