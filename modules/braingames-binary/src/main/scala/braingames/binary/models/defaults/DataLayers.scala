...
sealed trait DataLayer extends DataLayerLike{
  val baseDir: String
  val name: String
...
case class ColorLayer( elementClass: String = "uint8", supportedResolutions: List[Int]) extends DataLayer with ColorLayerLike with TrilerpInterpolation {
  val name = "color"
  val baseDir = name
}
case class ClassificationLayer( elementClass: String = "uint8", supportedResolutions: List[Int], flags: List[String]) extends DataLayer with ClassificationLayerLike with NearestNeighborInterpolation {
  val name = "classification"
  val baseDir = name
}
case class SegmentationLayer(batchId: Int, elementClass: String = "uint8", supportedResolutions: List[Int]) extends DataLayer with SegmentationLayerLike with NearestNeighborInterpolation {
