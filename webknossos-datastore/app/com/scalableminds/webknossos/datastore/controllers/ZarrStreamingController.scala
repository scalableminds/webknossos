    ...
    layer match {
      case d: WKWDataLayer =>
        ZarrDataLayer(
          ...
          d.boundingBox,
          d.elementClass,
          d.resolutions.map(x => DatasetLocatorMag(x, None, None, Some(AxisOrder.cxyz))),
      ...
      case s: WKWSegmentationLayer =>
        ZarrSegmentationLayer(
          ...
          s.boundingBox,
          s.elementClass,
          s.resolutions.map(x => DatasetLocatorMag(x, None, None, Some(AxisOrder.cxyz))),
          mappings = s.mappings,
      ...
      case z: ZarrDataLayer =>
        ZarrDataLayer(
          ...
          z.boundingBox,
          z.elementClass,
          z.resolutions.map(x => DatasetLocatorMag(x, None, None, Some(AxisOrder.cxyz))),
      ...
      case zs: ZarrSegmentationLayer =>
        ZarrSegmentationLayer(
          ...
          zs.boundingBox,
          zs.elementClass,
          zs.resolutions.map(x => DatasetLocatorMag(x, None, None, Some(AxisOrder.cxyz))),
