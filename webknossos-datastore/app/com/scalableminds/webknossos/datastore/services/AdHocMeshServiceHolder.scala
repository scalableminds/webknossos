...
class AdHocMeshServiceHolder @Inject() (actorSystem: ActorSystem)(implicit ec: ExecutionContext) {
  ...
  lazy val dataStoreAdHocMeshService: AdHocMeshService = new AdHocMeshService(
    dataStoreAdHocMeshConfig._1,
  ...
  lazy val tracingStoreAdHocMeshService: AdHocMeshService = new AdHocMeshService(
    tracingStoreAdHocMeshConfig._1,
    null,
    actorSystem,
