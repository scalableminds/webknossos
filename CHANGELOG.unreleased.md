...
- Updated the isValidName route in the API to return 200 for valid and invalid datasets. With this, the API version was bumped up to 6. [#7550](https://github.com/scalableminds/webknossos/pull/7550) 
