...
- When clicking a segment in the viewport, it is automatically focussed in the segment list. A corresponding context menu entry was added aswell. [#7512](https://github.com/scalableminds/webknossos/pull/7512)
