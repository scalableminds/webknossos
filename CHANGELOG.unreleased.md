...
- The AI-based Quick Select can now be run on multiple sections at once. This can be configured in the tool settings. Also, the underlying model now uses SAM 2. [#7965](https://github.com/scalableminds/webknossos/pull/7965)
