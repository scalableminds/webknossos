...
class CreditsView extends Backbone.Marionette.CompositeView
    ...
    <div class="well" id="credits">
      <div class="container">
        ...
        <section class="row">
          ...
          <div class="col-sm-3">
            <a href="http://www.neuro.mpg.de/helmstaedter">
              <img class="img-responsive" src="@controllers.routes.Assets.at("images/Max-Planck-Gesellschaft.svg")">
            </a>
            <a href="http://www.neuro.mpg.de/helmstaedter">
              <img class="img-responsive" src="@controllers.routes.Assets.at("images/Logo_MPI_cut.svg")">
            </a>
            <a href="http://www.scm.io">
              <img class="img-responsive" src="@controllers.routes.Assets.at("images/scalableminds_logo.svg")">
            </a>
          </div>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            <a href="@controllers.routes.Application.impressum">Legal notice</a>
          </p>
      </div>
    </div>
  """)
