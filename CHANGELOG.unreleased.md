...
- The fill tool is disabled in low magnifications (magnification 2 and lower) to avoid producing spotty annotations. [#5050](https://github.com/scalableminds/webknossos/pull/5050)
