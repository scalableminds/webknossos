...
![Trees can split by deleting the edge between two nodes or deleting a node. Two trees can be merged again by creating a new edge between them.](../.gitbook/assets/tracing_ui_tree_merge_split.gif)
...
![Skeletons can be imported by drag and drop in the tracing view or from the dashboard](../.gitbook/assets/tracing_ui_import.png)
