...
- Creating tasks no longer requires the usage of the taskTypeId. The task type summary can be used instead. [#6486](https://github.com/scalableminds/webknossos/pull/6486)
