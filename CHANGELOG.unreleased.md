...
- Improve loading of precomputed meshes and fix some issues (e.g., deleting a mesh which was still being loaded) could produce an invalid state. [#5506](https://github.com/scalableminds/webknossos/issues/5506)
