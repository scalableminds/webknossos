...
test.serial("generateDiffMessage should produce a nice human-readable message (1)", (t) => {
  const expectedString = "";
  t.is(generateDiffMessage({ changed: 0, onlyInOld: 0, onlyInNew: 0 }), expectedString);
});

test.serial("generateDiffMessage should produce a nice human-readable message (2)", (t) => {
  const expectedString = "There is 1 changed dataset.";
  t.is(generateDiffMessage({ changed: 1, onlyInOld: 0, onlyInNew: 0 }), expectedString);
});

test.serial("generateDiffMessage should produce a nice human-readable message (3)", (t) => {
...
test.serial("generateDiffMessage should produce a nice human-readable message (4)", (t) => {
  const expectedString = "There is 1 new dataset.";
  t.is(generateDiffMessage({ changed: 0, onlyInOld: 0, onlyInNew: 1 }), expectedString);
});

test.serial("generateDiffMessage should produce a nice human-readable message (5)", (t) => {
...
test.serial("generateDiffMessage should produce a nice human-readable message (6)", (t) => {
  const expectedString =
...
test.serial("generateDiffMessage should produce a nice human-readable message (7)", (t) => {
...
test.serial("generateDiffMessage should produce a nice human-readable message (8)", (t) => {
  const expectedString =
