...
- Optimized processing of parallel requests (new thread-pool config), improving performance and reducing idle waiting. [#7137](https://github.com/scalableminds/webknossos/pull/7137)
