    ...
    for {
      ...
      r <- run(q"""
          SELECT
            ...
            u.isdatasetmanager,
            u.isdeactivated,
            ARRAY_AGG(t._id) AS team_ids,
            ARRAY_AGG(t.name) AS team_names,
            ARRAY_AGG(utr.isteammanager :: TEXT) AS team_managers,
            ARRAY_AGG(ux.value) AS experience_values,
            ARRAY_AGG(ux.domain) AS experience_domains,
            u.lastactivity,
            o._id,
            o.name,
