...
## nml
    ...
    `<things>␊
      ...
      <parameters>␊
        <experiment name="Test Dataset" description="" organization="Connectomics department" wkUrl="http://localhost" />␊
        <scale x="5" y="5" z="5" unit="nm" />␊
        <offset x="0" y="0" z="0" />␊
        <time ms="0" />␊
...
## nml-with-additional-coordinates
...
## nml-special-chars
    ...
    `<things>␊
      ...
      <meta name="taskId" content="5b1fd1cb97000027049c67ec" />␊
      <parameters>␊
        <experiment name="Test Dataset" description="Multiline dataset&#xa;description&#xa;with special &amp;&apos;&lt;&gt;&quot; chars." organization="Connectomics department" wkUrl="http://localhost" />␊
        <scale x="5" y="5" z="5" unit="nm" />␊
        <offset x="0" y="0" z="0" />␊
        <time ms="0" />␊
        <editPosition x="0" y="0" z="0" />␊
