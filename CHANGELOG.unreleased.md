...
- Fixed that meshes weren't loaded correctly if the precomputed mesh file contained multiple level-of-details. [#8519](https://github.com/scalableminds/webknossos/pull/8519)
