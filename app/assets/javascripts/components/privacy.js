    ...
    <Row>
      <Col offset={6} span={12}>
        ...
        <p>
          ...
          describes the data that is processed, the rights data subjects have, what external
        ...
        <ul>
          <li>
            &quot;<strong>webKnossos</strong>&quot; is the application that can be used for viewing
            and annotating 3D image datasets.
          </li>
          <li>
          ...
          <li>
            ...
            technically represented as an &quot;<strong>organization</strong>&quot; in webKnossos.
            The organization or their representative is the data controller of the information
            within their instance of webKnossos.
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                Francisco, CA 94105, USA. The legal basis for using NewRelic is a legitimate
              ...
              <li>
                ...
                when a data subject or automated systems calls up webKnossos. This general data and
                ...
                that may be used in the event of attacks on our information technology systems. This
                data is used for resolving errors and therefore to ensure uninterrupted service.
                Logs are automatically deleted after 30 days. The legal basis for collecting logs is
                a legitimate interest to provide and improve the service.
              </li>
            </ul>
          </li>
          <li>
            ...
            This data is attached to the user&apos;s account. It is used to identify the annotation
            data that was created by the user and for administrative purposes. The legal bases are
            user consent (upon signup) or legitimate interests in order to provide the Service.
          </li>
          <li>
            Registered users may participate in discussions on the webKnossos discuss platform.
            Posts and replies that they make there are visible to other webKnossos users (also from
            other webKnossos instances). Their posts and replies may be removed at any time.
          </li>
          <li>
            ...
            the internet. Personal data such as name, email address and organization affiliation may
            be made public as well in order to provide the attribution that is common within the
        ...
        <p>
          ...
          enabled to analyze the use of our website. With each call-up to one of the individual
          pages of this Internet site, which is operated by the controller and into which a Google
          Analytics component was integrated, the Internet browser on the information technology
          system of the data subject will automatically submit data through the Google Analytics
          component for the purpose of online advertising and the settlement of commissions to
          Google. During the course of this technical procedure, the enterprise Google gains
          knowledge of personal information, such as the IP address of the data subject, which
        ...
        <p>
          ...
          address of the Internet access used by the data subject, will be transmitted to Google in
          the United States of America. These personal data are stored by Google in the United
        ...
        <p>
          ...
          subject is later deleted, formatted, or newly installed, then the data subject must
          ...
          competence, or is disabled, it is possible to execute the reinstallation or reactivation
