...
Hover over existing tree groups to bring up a little menu for creating new groups and deletion. Renaming of a group can be done my selecting a group and then entering the new name into the input above the tree hierarchy structure view.
