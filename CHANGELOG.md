...
### Added
- Added `publicUri` configs for datastore and tracingstore for initial setup. [#](https://github.com/scalableminds/webknossos/pull/)
...
### Changed
- Consolidates URI handling in the config. Pairs of `uri` and `secured` entries are now specified as just `uri` and require either `http://` or `https://` prefix. [#](https://github.com/scalableminds/webknossos/pull/)
- Renamed initial organization for the dev deployment to `sample`. [#](https://github.com/scalableminds/webknossos/pull/)
