...
import com.scalableminds.webknossos.datastore.binary.models.datasource.{DataLayer, DataSourceId, ElementClass}
import com.scalableminds.webknossos.datastore.binary.models.{BucketPosition, CubePosition}
