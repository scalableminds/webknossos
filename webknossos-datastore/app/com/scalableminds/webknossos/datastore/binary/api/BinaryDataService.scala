...
import com.scalableminds.webknossos.datastore.binary.models.requests.{DataReadInstruction, DataServiceDataRequest, DataServiceMappingRequest, MappingReadInstruction}
