...
class AdHocMeshingServiceHolder @Inject()(actorSystem: ActorSystem)(implicit ec: ExecutionContext) {
  ...
  lazy val dataStoreAdHocMeshingService: AdHocMeshingService = new AdHocMeshingService(dataStoreAdHocMeshingConfig._1,
  ...
  lazy val tracingStoreAdHocMeshingService: AdHocMeshingService = new AdHocMeshingService(tracingStoreAdHocMeshingConfig._1,
                                                                                    null,
                                                                                    actorSystem,
