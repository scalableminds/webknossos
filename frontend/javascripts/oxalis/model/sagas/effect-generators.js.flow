...
import { type Channel, type Effect, type Pattern, type Task as _Task, type Saga as _Saga, channel, effects } from "redux-saga";
import {
  all as typedAll,
  race as typedRace,
  take as typedTake,
  ...
  takeLatest as typedTakeLatest,
  throttle as typedThrottle,
  debounce as typedDebounce,
  cancel as typedCancel,
  actionChannel as typedActionChannel,
  fork as typedFork,
...
declare type Fn8<T1, T2, T3, T4, T5, T6, T7, T8, R> = (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8) => Promise<R> | Generator<*, R, *> | R;
declare type Fn9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> = (t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9) => Promise<R> | Generator<*, R, *> | R;
...
declare type ContextCallFn = (<R, C: Context, Fn: Fn0<R>>(cfn: [C, Fn], ...rest: Array<void>) => Generator<*, R, *>) &
  ...
  (<T1, T2, T3, T4, T5, T6, T7, T8, R, C: Context, Fn: Fn8<T1, T2, T3, T4, T5, T6, T7, T8, R>>(cfn: [C, Fn], t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, ...rest: Array<void>) => Generator<*, R, *>) &
  (<T1, T2, T3, T4, T5, T6, T7, T8, T9, R, C: Context, Fn: Fn9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R>>(cfn: [C, Fn], t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8, t9: T9, ...rest: Array<void>) => Generator<*, R, *>);
...
declare type CallFn = ContextCallFn &
  ...
  (<T1, T2, T3, T4, T5, T6, T7, T8, R, Fn: Fn8<T1, T2, T3, T4, T5, T6, T7, T8, R>>(fn: Fn, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8) => Generator<*, R, *>);
// & (<T, R, Fn: FnSpread<T, R>>(fn: Fn, ...args: Array<T>) => Generator<*, R, *>);

/* ------------------ RETRY Stuff ------------------ */

declare type RetryFn =
  (<T1, R, Fn: Fn1<T1, R>>(maxTries: number, delay: number, fn: Fn, t1: T1) => Generator<*, R, *>) &
  (<R, Fn: Fn0<R>>(maxTries: number, delay: number, fn: Fn) => Generator<*, R, *>) &
  (<T1, T2, R, Fn: Fn2<T1, T2, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2) => Generator<*, R, *>) &
  (<T1, T2, T3, R, Fn: Fn3<T1, T2, T3, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2, t3: T3) => Generator<*, R, *>) &
  (<T1, T2, T3, T4, R, Fn: Fn4<T1, T2, T3, T4, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2, t3: T3, t4: T4) => Generator<*, R, *>) &
  (<T1, T2, T3, T4, T5, R, Fn: Fn5<T1, T2, T3, T4, T5, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => Generator<*, R, *>) &
  (<T1, T2, T3, T4, T5, T6, R, Fn: Fn6<T1, T2, T3, T4, T5, T6, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6) => Generator<*, R, *>) &
  (<T1, T2, T3, T4, T5, T6, T7, R, Fn: Fn7<T1, T2, T3, T4, T5, T6, T7, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7) => Generator<*, R, *>) &
  (<T1, T2, T3, T4, T5, T6, T7, T8, R, Fn: Fn8<T1, T2, T3, T4, T5, T6, T7, T8, R>>(maxTries: number, delay: number, fn: Fn, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7, t8: T8) => Generator<*, R, *>);
...
declare export var retry: RetryFn;
...
declare export var _takeLatest: typeof typedTakeLatest;
declare export var _takeLeading: typeof typedTakeLeading;
declare export var _takeLatest: typeof typedTakeLatest;
declare export var _throttle: typeof typedThrottle;
declare export var _debounce: typeof typedDebounce;
declare export var _cancel: typeof typedCancel;
declare export var _actionChannel: typeof typedActionChannel;
declare export var _delay: typeof typedDelay;
declare export var _actionChannel: typeof typedActionChannel;
declare export var _fork: typeof typedFork;
