...
WEBKNOSSOS reads N5 but does not write it. To produce N5 datasets, use the external N5 tooling from the [N5 ecosystem](https://github.com/saalfeldlab/n5) (e.g. the n5 Java or Python libraries). If you want WEBKNOSSOS to create a dataset for you, consider the natively supported [Zarr](./zarr.md) or [WKW](./wkw.md) formats instead.
