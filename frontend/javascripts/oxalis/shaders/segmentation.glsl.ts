  ...
  code: `
    ...
    vec3 convertCellIdToRGB(vec4 idHigh, vec4 idLow) {
      ...
      */
      ...
      float baseVoxelSize = min(min(datasetScaleFactor.x, datasetScaleFactor.y), datasetScaleFactor.z);
      vec3 anisotropyFactorUVW = transDim(datasetScaleFactor) / baseVoxelSize;
