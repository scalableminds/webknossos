...
- WEBKNOSSOS now locks a shared annotation where others may edit to a single user at a time to avoid conflicts. [#6819](https://github.com/scalableminds/webknossos/pull/6819)
