...
function useSampleDatasets(
  ...
  const [datasets, setDatasets] = useState<APISampleDataset[]>([]);
  ...
  const updateFailedDatasets = (sampleDatasets: APISampleDataset[]) => {
  ...
  const updatePendingDatasets = (sampleDatasets: APISampleDataset[]) => {
    setPendingDatasets(
      sampleDatasets
