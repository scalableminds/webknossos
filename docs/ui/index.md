...
![An overview of the WEBKNOSSOS annotation UI highlighting the 5 main sections of the interface](../images/user_interface.png)
/// caption
An overview of the WEBKNOSSOS annotation UI highlighting the 5 main sections of the interface
///
