...
declare module "ava" {
  declare interface PromiseLike<R> {
    ...
    then<U>(onFulfill: null | void, onReject: (error: mixed) => Promise<U> | U): Promise<R | U>;
    then<U>(
  ...
  declare type Assertions = {|
    ...
    |},
    throws: {|
      <ThrownError: Error>(fn: () => mixed, expectations?: null, message?: string): ThrownError,
      <ThrownError: Error>(
        fn: () => mixed,
        constructor: Constructor,
        message?: string,
      ): ThrownError,
      <ThrownError: Error>(fn: () => mixed, regex: RegExp, message?: string): ThrownError,
      <ThrownError: Error>(fn: () => mixed, errorMessage: string, message?: string): ThrownError,
      <ThrownError: Error>(
        fn: () => mixed,
  ...
  declare type Implementation<Context> = (t: ExecutionContext<Context>) => ImplementationResult;
  declare type CbImplementation<Context> = (t: CbExecutionContext<Context>) => ImplementationResult;
  ...
  declare export type TestInterface<Context = void> = {|
    ...
    (title: string, macro: Macro<Context> | Macro<Context>[], ...args: Array<mixed>): void,
  ...
  declare type Cb<Context> = {|
    ...
    (title: string, macro: CbMacro<Context> | CbMacro<Context>[], ...args: Array<mixed>): void,
