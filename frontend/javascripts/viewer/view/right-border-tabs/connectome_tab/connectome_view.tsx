...
import ConnectomeFilters from "viewer/view/right-border-tabs/connectome_tab/connectome_filters";
import ConnectomeSettings from "viewer/view/right-border-tabs/connectome_tab/connectome_settings";
import type {
  Agglomerate,
  ConnectomeData,
  TreeNode,
