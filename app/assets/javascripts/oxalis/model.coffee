      ...
      if tracing.error
        ...
        Request.send(
          ...
          (user) =>
            ...
            @binary = new Binary(@user, tracing.content.dataSet, TEXTURE_SIZE_P, "volume", 24)
            @binaryVolume = new Binary(@user, tracing.content.dataSet, TEXTURE_SIZE_P, "volume", 24, true)
