...
class DataSetActor extends Actor {
  ...
  val dataStores = List(new GridDataStore(BinaryCacheAgent), new FileDataStore(BinaryCacheAgent), new EmptyDataStore(BinaryCacheAgent))
