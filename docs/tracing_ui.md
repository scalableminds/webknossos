...
When **viewing a dataset** (not available in tracings) with a segmentation layer, the experimental "Render Isosurfaces" setting can be enabled within the dataset settings.
