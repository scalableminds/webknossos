...
export function updateKey<
  Key1 extends keyof OxalisState
>(state: OxalisState, key: keyof OxalisState, shape: Partial<OxalisState[Key1]>): OxalisState {
...
>(state: OxalisState, key1: TKey1, key2: TKey2, shape: Partial<OxalisState[TKey1][TKey2]>): OxalisState {
  // @ts-expect-error
