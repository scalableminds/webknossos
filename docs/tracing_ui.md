...
The skeleton annotation layer contains any trees that you add to your dataset. You can quickly toggle the visibility of all trees by enabling/disabling this layer.
