...
case class OpenIdConnectUserInfo(given_name: String, family_name: String, email: String) derives AutoFormat

case class JsonWebKeySet(keys: Seq[JsonWebKey]) derives AutoFormat
