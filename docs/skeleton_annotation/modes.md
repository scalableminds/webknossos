...
WEBKNOSSOS supports several modes for displaying your dataset and interacting with (skeleton) annotations.
...
This view lets you inspect your data at highest quality along the main imaging axis (usually XY).
...
Seasoned annotators can follow tube-like structures, such as dendrites or axons, as if they were flying through them, similar to a racing game or flight simulator.
