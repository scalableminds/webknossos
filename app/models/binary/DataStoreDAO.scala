...
case class DataStore(name: String, key: String = UUID.randomUUID().toString, typ: String)

case class DataStoreInfo(name: String, url: String, typ: String, accessToken: Option[String])
