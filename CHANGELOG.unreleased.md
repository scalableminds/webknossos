...
### Added
- Added displaying subfolders of the currently active folder to the dataset table in the dashboard. [#6996](https://github.com/scalableminds/webknossos/pull/6996)
