...
type SetTreeAgglomerateIdAction = ReturnType<typeof setTreeAgglomerateIdAction>;
...
export const setTreeAgglomerateIdAction = (
  agglomerateId: number,
  treeId?: number | null | undefined,
) =>
  ({
    type: "SET_TREE_AGGLOMERATE_ID",
    agglomerateId,
    treeId,
  }) as const;
