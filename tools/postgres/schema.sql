...
CREATE TABLE webknossos.users(
  ...
  lastOpenedReleasesTimestamp TIMESTAMPTZ NOT NULL DEFAULT NOW(),
...
m.created AS multiuser_created, u._multiUser, m._lastLoggedInIdentity, u.lastActivity, u.lastOpenedReleasesTimestamp
