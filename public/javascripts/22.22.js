webpackJsonp([22],Array(78).concat([
/* 78 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatasetEditView, FormSyphon, Marionette, Toast, _, app,
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;
	...
	DatasetEditView = (function(superClass) {
	  ...
	  DatasetEditView.prototype.events = {
	    "submit form": "submitForm"
	  };
	
	  DatasetEditView.prototype.ui = {
	    "form": "form"
	  };
	
	  DatasetEditView.prototype.initialize = function() {
	    this.listenTo(this.model, "sync", this.render);
	    return this.model.fetch();
	  };
	
	  DatasetEditView.prototype.submitForm = function(event) {
	    var formValues;
