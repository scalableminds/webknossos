...
test("Shader syntax: Ortho Mode", (t: ExecutionContext<any>) => {
  const code = getMainFragmentShader({
    ...
    textureLayerInfos: {
      ["color_layer_1"]: { packingDegree: 4.0, dataTextureCount: 1, isSigned: false },
      ["color_layer_2"]: { packingDegree: 4.0, dataTextureCount: 1, isSigned: false },
    },
...
test("Shader syntax: Ortho Mode + Segmentation - Mapping", (t: ExecutionContext<any>) => {
  const code = getMainFragmentShader({
    ...
    textureLayerInfos: {
      ["color_layer_1"]: { packingDegree: 4.0, dataTextureCount: 1, isSigned: false },
      ["color_layer_2"]: { packingDegree: 4.0, dataTextureCount: 1, isSigned: false },
      ["segmentationLayer"]: { packingDegree: 1.0, dataTextureCount: 4, isSigned: false },
    },
    orderedColorLayerNames: ["color_layer_1", "color_layer_2"],
...
test("Shader syntax: Ortho Mode (rgb and float layer)", (t: ExecutionContext<any>) => {
  const code = getMainFragmentShader({
    ...
    colorLayerNames: ["color_layer_1", "color_layer_2"],
    textureLayerInfos: {
      ["color_layer_1"]: { packingDegree: 1.0, dataTextureCount: 1, isSigned: false },
      ["color_layer_2"]: { packingDegree: 4.0, dataTextureCount: 1, isSigned: false },
    },
    orderedColorLayerNames: ["color_layer_1", "color_layer_2"],
    segmentationLayerNames: [],
