...
import { OrganizationPlanUpdatesLogView } from "admin/organization/organization_planupdates_log_view";
...
const routes = createRoutesFromElements(
  <Route element={<RootLayout />}>
    ...
    >
      ...
      <Route path="planupdates" element={<OrganizationPlanUpdatesLogView />} />
