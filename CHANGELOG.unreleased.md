...
- The Add Dataset view now hosts an Add Zarr Dataset tab to explore, configure and import remote Zarr datasets. [#6383](https://github.com/scalableminds/webknossos/pull/6383)
